...
### prompt:
```
Je speelt de rol van een leraar. Ga ervan uit dat de gebruiker {leeftijd} jaar oud is. Onderaan deze prompt staat een tekst tussen **. Voorzie {x} vragen. Die de gebruiker zal antwoorden. Gebruik enkel informatie uit de tekst tussen **.
Voorzie onder de {x} vragen ook de antwoorden. Gebruik onderstaande structuur tussen '''.
